# core/management/commands/init_pisignage.py
...
class Command(BaseCommand):
    help = 'Initialize PiSignage system with default data'
    
    def handle(self, *args, **options):
        self.stdout.write('Initializing PiSignage system...')
        ...
        try:
            ...
            default_playlist, created = Playlist.objects.get_or_create(
                ...
                defaults={
                    ...
                    'layout': layout_1,
                    'ticker_enabled': True,
                    'ticker_text': 'Welcome to PiSignage Digital Signage System',
                    'ticker_speed': 5,
        ...
        # 6. Mostrar resumen
        self.stdout.write('\n' + '='*50)
        self.stdout.write(self.style.SUCCESS('PiSignage initialization completed!'))
        ...
        self.stdout.write(self.style.SUCCESS('\n✅ PiSignage Django port is ready!'))
